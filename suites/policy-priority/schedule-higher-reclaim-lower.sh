...
fristExpected="/root, demand:$taskNum, assigned:0, planned:0, ratio:$fristPriority"
secondExpected="/root, demand:$taskNum, assigned:$SLOTS_PER_HOST, planned:$SLOTS_PER_HOST, ratio:$secondPriority"
