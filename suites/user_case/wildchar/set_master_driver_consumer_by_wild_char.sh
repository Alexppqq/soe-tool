...
ca_assert_file_contain_key_word "$global_case_log_dir/allocList" "/A$randomConsumer" "consumer does not take effect,please check the ego install pakage date by egosh -V, the data should be after jan 25 2016"
